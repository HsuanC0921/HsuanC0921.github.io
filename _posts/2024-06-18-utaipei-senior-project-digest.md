...
這項專題研究最初計劃對Mistral 7B大型語言模型進行中文微調，但由於大規模的微調需要強大硬體資源，花費的金錢也相當可觀，我改為嘗試透過合併的方式建立一個能理解中文的程式助手。
...
研究結論中我也指出，僅管BreezeDolphin有潛力成為不錯的程式助手，但需要收集更多高品質語料、改進生成能力、探索新模型架構訓練方法等，才能進一步提升後續型號模型的表現。
