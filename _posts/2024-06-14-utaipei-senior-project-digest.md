...
本文介紹了我在臺北市立大學資訊科學系的資訊專題報告研究，標題為"LLM應用實戰"。由於沒有參加競賽，為了保持專題報告的公開性，我將報告內容的精簡版本公開在此(專題報告的原文在文末)，供網際網路上的任何人公開閱覽。

這項研究最初計劃對Mistral 7B大型語言模型進行中文微調，但由於大規模的微調需要強大硬體資源，花費的金錢也相當可觀，我改為嘗試透過合併的方式建立一個能理解中文的程式助手。

為了找到符合我要求且效果良好的模型，我從數百個不同的公開LLM模型中挑選出聯發科的Breeze 7B和Cognitive Computation的Dolphin 2.6 Mistral 7B兩個模型中選取並合併。經過參數合併，我獲得了我稱其為BreezeDolphin的這個模型。
...
研究結論中我也指出，儘管BreezeDolphin有潛力成為不錯的程式助手，但需要收集更多高品質語料、改進生成能力、探索新模型和訓練方法等，才能進一步提升其表現。我也總結了一些其他的建議和檢討內容，希望對未來研究和個人進修能有所幫助。

因為是精簡版的報告，故沒有詳細列出一一對應的資料來源。但文末附有專題全文、解說影片、發表簡報、線上Demo網址、前端UI的GitHub倉庫和發布在HuggingFace上的合併後的模型等附錄資料，供讀者參考。
